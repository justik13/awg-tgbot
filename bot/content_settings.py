...
TEXT_DEFAULTS: dict[str, str] = {
    "start": (
        ...
        "3) Импортируйте <code>ключ://</code> в Amnezia\n\n"
    ...
    "instruction_body": (
        ...
        "4. Выберите устройство и скопируйте <code>ключ://</code> ключ\n"
    ...
    "configs_menu": (
        ...
        "Сначала я отправлю:\n"
        "• <code>ключ://</code> — быстрый импорт в Amnezia.\n\n"
    ...
    "config_vpn_ready": "🔐 <b>ключ:// для устройства {device_num}</b>\n\n<code>{vpn_key}</code>\n\nПодходит для быстрого импорта в Amnezia.",
    ...
    "payment_success": "🎉 <b>Доступ готов</b>\n\nПодключение уже выпущено и готово к использованию.",
    ...
    "payment_next_step": (
        "Следующий шаг: откройте <b>🔑 Подключение</b>, выберите нужное устройство и импортируйте <code>ключ://</code> в Amnezia.\n"
        "В подписке доступно до <b>{configs_per_user}</b> устройств."
    ),
    ...
    "referral_screen": (
        ...
        "✅ Оплатили впервые: <b>{rewarded_count_first_payment}</b>\n"
        "🎁 За первые оплаты друзей: <b>{inviter_first_payment_bonus_days_total} дн.</b>\n"
        "🔁 Повторные бонусы вам: <b>{inviter_recurring_bonus_days_total} дн.</b>\n"
        "💎 Всего вам начислено: <b>{inviter_bonus_days_total} дн.</b>\n"
        "🤝 Друзьям начислено: <b>{friends_bonus_days_total} дн.</b>\n"
        "🙌 Вам как приглашённому: <b>{user_invitee_bonus_days_total} дн.</b>\n\n"
        "Как работает:\n"
    ...
    "policy_sensitive": "ℹ️ Часть чувствительных сайтов/сервисов может быть недоступна через по policy сервиса.",
...
TEXT_REQUIRED_PLACEHOLDERS: dict[str, set[str]] = {
    ...
    "instruction_body": {"download_url"},
    "support_useful": {"download_url"},
    "profile_screen": {
        "first_name",
        "tg_username",
        "user_id",
    ...
    "referral_screen": {
        "ref_link",
        "invited_count",
        "rewarded_count_first_payment",
        "inviter_first_payment_bonus_days_total",
        "inviter_recurring_bonus_days_total",
        "inviter_bonus_days_total",
        "friends_bonus_days_total",
        "user_invitee_bonus_days_total",
        "recurring_min_purchase_days",
    },
