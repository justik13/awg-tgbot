...
**Установка AWG** | Выполняется автоматически официальным клиентом Amnezia по SSH через SELF-HOSTED. Бот не управляет установкой/деплоем AWG. | 
...
### Для пользователей:
- 🔑 Генерация AMNEZIAWG конфигов через Telegram
